...
bool CAT3DVideo::OnControlEvent(const CATEvent& eventMsg, CATInt32& returnVal)
{
														...
														LPARAM lParam)
{
	...
	CAT3DVideo* wnd3d = (CAT3DVideo*)GetWindowLongPtr(hwnd,GWLP_USERDATA);
...
void CAT3DVideo::On3DMouseMove(CATFloat32 xOff, CATFloat32 yOff, bool leftBtn, bool midBtn, bool rightBtn)
{
...
void CAT3DVideo::CenterViewport()
{
	// Zero rotations
	this->fViewRotX = 0.0;
	this->fViewRotY = 0.0;
...
void CAT3DVideo::SetAxisDisplay(bool on, bool corner)
{
...
void CAT3DVideo::Set3dFacets(	CATC3DPoint* pointArray, CATInt32 numScans, CATInt32 height, bool triangles)
{
	// Connect to the OpenGL RC
	HDC hdc = GetDC(this->fHwnd);	
	::wglMakeCurrent(hdc,fHRC);
...
CATResult CAT3DVideo::Start()
{
	return fCapture.Start();
}

CATResult CAT3DVideo::Stop()
{
